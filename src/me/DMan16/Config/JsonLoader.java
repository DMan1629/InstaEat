...
public class JsonLoader {
	...
	public void write(String fileName, Object object, JSONObject defaultFormat) {
	...
	public <V> JSONObject read(String fileName, Class<V> vClass, JSONObject defaultFormat) {
		path = dir.resolve(fileName);
		if (!Files.exists(path, new LinkOption[0])) {
			write(fileName,vClass,defaultFormat);
		}
